    ...
    el(
      ...
      el(
        ...
        el(
          ...
          'Open immediately while the three Midnight wallet cores sync through Nightfrost in the background, then receive and send unshielded Preview NIGHT with local signing.',
        ),
...
/// stages, a note on where the proof is generated plus a live elapsed
    ...
    status.append(
      ...
      el(
        ...
        BROWSER_PROVING
          ...
          : 'The zero-knowledge proof is generated by the Nightfrost proof server • this usually takes a minute or two. Keep the tab open.',
      ),
    );
...
/// Nokia-style snake shown under the proving note so the wait for the proof
/// has something to fill it with. One game per proving run: each
  ...
  form.addEventListener('submit', (event) => {
    ...
    setBusyStatus(
      ...
      BROWSER_PROVING
        ...
        : 'The transaction is built and signed locally, then proven by the Nightfrost proof server before Nightfrost receives it.',
    );
    ...
    el(
      ...
      el(
        ...
        BROWSER_PROVING
          ...
          : 'Preview example: sync through Nightfrost, prove through the Nightfrost proof server, then submit through the Nightfrost API.',
      ),
      form,
      el(
        'p',
