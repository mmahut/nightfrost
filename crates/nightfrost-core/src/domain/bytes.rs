...
// Vendored and adapted from midnight-indexer (indexer-common/src/domain/bytes.rs).
...
#[derive(Default, Clone, PartialEq, Eq, Hash, AsRef, Deref, From, Into, Serialize, Deserialize)]
#[as_ref([u8])]
#[from(Vec<u8>, &[u8])]
